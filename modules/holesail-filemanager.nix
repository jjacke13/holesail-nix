    ...
    type = types.attrsOf (types.submodule {
      options = {
        ...
        connector = mkOption {
          type = types.str;
          default = "";
          description = "The connection string to the Holesail filemanager. If empty, a random one will be generated by holesail.";
        };
        connector-file = mkOption {
          type = types.str;
          default = "";
          description = "The path to a file containing the connection string to the Holesail filemanager. If null, the connection-string option will be used.";
        };
        public = mkOption {
          type = types.bool;
          default = false;
          description = "Whether to announce the filemanager to the DHT. If true, connector must be empty.";
        };
        username = mkOption {
          type = types.str;
          default = "admin";
